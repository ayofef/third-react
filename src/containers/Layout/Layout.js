...
const CuflInternational = React.lazy(() =>
  import("../Cufl/CuflInternational/CuflInternational")
);
const CuflResources = React.lazy(() =>
  import("../Cufl/Resources/CuflResources")
);
const CfaiResources = React.lazy(() =>
  import("../Cfai/Resources/CfaiResources")
);
const IufuResources = React.lazy(() =>
  import("../Iufu/Resources/IufuResources")
);
const WscaiResources = React.lazy(() =>
  import("../Wscai/Resources/WscaiResources")
);
  ...
  return (
    <React.Fragment>
      ...
      <Switch>
        ...
        />
        <Route
          path="/cufl/leagues/:slug/fixtures-result"
          exact
          component={() => (
            <Suspense fallback={<Loader />}>
              <Leagues />
        ...
        />
        <Route
          path="/cufl/leagues/:slug/standings"
          exact
          component={() => (
            <Suspense fallback={<Loader />}>
              <Leagues />
