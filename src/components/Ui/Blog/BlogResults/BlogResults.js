...
function BlogResults() {
  ...
  const sortedDataFixtures = DataFixtures.slice().sort(
  ...
  if (sortedDataFixtures && sortedDataFixtures.length >= 1) {
    return (
      <aside className={classes.BlogResults}>
        <h2 className={classes.BlogResults__Heading}>
        ...
        <div className={classes.BlogResults__LinkBox}>
          <Link
            to="/cufl/leagues"
            className={classes.BlogResults__LinkBox__Link}
          >
            CFAI Cup
          </Link>
          <Link
          ...
          <Link
            to="/cufl/leagues/premier-division"
            className={classes.BlogResults__LinkBox__Link}
          >
            Cufl League
          </Link>
